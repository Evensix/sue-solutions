...
import { DropdownSection, DropdownSectionProps, dropdownItemStyles } from './ListBox.tsx';
...
export function MenuSeparator(props: SeparatorProps) {
  return <Separator {...props} className="mx-3 my-1 border-b border-neutral-300 dark:border-secondary-700" />
}

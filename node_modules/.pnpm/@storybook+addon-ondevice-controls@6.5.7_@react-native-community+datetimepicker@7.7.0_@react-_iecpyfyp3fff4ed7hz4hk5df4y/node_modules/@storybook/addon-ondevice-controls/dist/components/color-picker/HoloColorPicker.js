...
HoloColorPicker.propTypes = {
    color: prop_types_1.default.oneOfType([
        ...
        prop_types_1.default.shape({
            h: prop_types_1.default.number,
            s: prop_types_1.default.number,
            v: prop_types_1.default.number,
        }),
    ]),
    defaultColor: prop_types_1.default.string,
    oldColor: prop_types_1.default.string,
    onColorChange: prop_types_1.default.func,
    onColorSelected: prop_types_1.default.func,
    onOldColorSelected: prop_types_1.default.func,
    hideSliders: prop_types_1.default.bool,

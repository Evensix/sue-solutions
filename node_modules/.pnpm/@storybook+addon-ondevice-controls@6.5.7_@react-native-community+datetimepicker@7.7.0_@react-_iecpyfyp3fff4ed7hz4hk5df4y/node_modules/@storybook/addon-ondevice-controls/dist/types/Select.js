...
const WebSelect = (0, react_native_theming_1.styled)('select')(({ theme }) => ({
    ...(0, common_1.inputStyle)(theme),
}));
...
const SelectType = ({ arg, onChange }) => {
    ...
    if (react_native_1.Platform.OS === 'web') {
        ...
        return ((0, jsx_runtime_1.jsx)(WebSelect, { value: value, onChange: handleChange, children: options.map(({ label, key }) => ((0, jsx_runtime_1.jsx)("option", { value: key, children: label }, `${label}-${key}`))) }));
    }
    return ((0, jsx_runtime_1.jsx)(react_native_1.View, { children: (0, jsx_runtime_1.jsx)(react_native_modal_selector_1.default, { data: options, initValue: String(value), onChange: (option) => onChange(option.key), animationType: "none", keyExtractor: ({ key, label }) => `${label}-${key}`, children: (0, jsx_runtime_1.jsx)(Input, { editable: false, value: String(selected), autoCapitalize: "none", underlineColorAndroid: "transparent" }) }) }));
};
